...
export default function TermsPage() {
  return <><Header /><main className="legal container"><p className="eyebrow">Last updated September 15, 2026</p><h1>Terms of Service</h1>
    ...
    <section><h2>Availability and changes</h2><p>OpenTrackMail is provided without a guarantee of uninterrupted operation. We may change or discontinue features when needed for reliability, security, legal compliance, or maintainability.</p></section>
    ...
    <section><h2>Contact</h2><p>Questions about these terms can be sent to <a href="mailto:legal@opentrackmail.com">legal@opentrackmail.com</a>.</p></section>
  </main><Footer /></>;
}
