...
export default function PrivacyPage() {
  return <><Header /><main className="legal container"><p className="eyebrow">Last updated September 15, 2026</p><h1>Privacy Policy</h1>
    ...
    <section><h2>Retention and deletion</h2><p>Tracked-email and event data is retained until the account holder deletes individual history, all tracking history, or the account. Operational logs maintained by infrastructure providers may have separate limited retention periods.</p></section>
    ...
    <section><h2>Service providers and contact</h2><p>OpenTrackMail uses Supabase for authentication and database hosting and Vercel for application hosting. Their processing is governed by their own terms and data-processing agreements. Privacy questions can be sent to <a href="mailto:privacy@opentrackmail.com">privacy@opentrackmail.com</a>.</p></section>
  </main><Footer /></>;
}
